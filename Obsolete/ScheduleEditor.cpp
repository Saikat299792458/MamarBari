...
LRESULT CALLBACK windpro(HWND h,UINT u,WPARAM w,LPARAM l)
{
    ...
    case WM_CREATE:
        ...
        CreateWindowEx(WS_EX_WINDOWEDGE,
                                   "Static","Select a Destination folder of installation:",
                                   WS_CHILD|WS_VISIBLE,
                                   10,20,500,40,
                                   h,(HMENU)ID_STATIC,
                                   NULL,NULL);
        HWND he=CreateWindowEx(WS_EX_CLIENTEDGE,
                                   "edit","Browse",
                                   WS_CHILD|WS_VISIBLE|ES_NOHIDESEL|ES_AUTOHSCROLL,
                                   75,102,250,26,
                                   h,(HMENU)ID_EDITBOX,
                                   NULL,NULL);
        strcpy(path,defpath);
    ...
    case WM_COMMAND:
        ...
        case ID_INSTALL:
            destroyer(h);
            CreateWindowEx(WS_EX_WINDOWEDGE,
                                   "Static","Installation in Progress:",
                                   WS_CHILD|WS_VISIBLE,
                                   10,20,500,20,
                                   h,(HMENU)ID_STATIC,
                                   NULL,NULL);
            ...
            SetWindowLong(GetDlgItem(h,ID_FINISH),GWL_STYLE,WS_CHILD|WS_VISIBLE|BS_DEFPUSHBUTTON);
            SetWindowLong(GetDlgItem(h,ID_CANCEL),GWL_STYLE,WS_CHILD|WS_VISIBLE|WS_DISABLED);
    ...
    case WM_KEYDOWN:
        {
            ...
            {
            case VK_RIGHT:
                SetWindowLong(GetDlgItem(h,ID_INSTALL),GWL_STYLE,WS_CHILD|WS_VISIBLE|BS_PUSHBUTTON);
                ...
                break;
            case VK_LEFT:
                SetWindowLong(GetDlgItem(h,ID_INSTALL),GWL_STYLE,WS_CHILD|WS_VISIBLE|BS_DEFPUSHBUTTON);
